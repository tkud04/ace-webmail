...
<head>
	...
	<title><?php echo $__env->yieldContent('title'); ?> | TS MAILER</title>
    ...
    <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">TS MAILER</a>
...
<?php /**PATH C:\bkupp\lokl\repo\tobis-mailer\resources\views/layout.blade.php ENDPATH**/ ?>