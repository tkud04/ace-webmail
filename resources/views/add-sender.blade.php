...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{url('add-sender')}}" id="as-form" method="post" enctype="multipart/form-data">
										{!! csrf_field() !!}
										...
										<div class="row">
										  ...
										  <div class="form-group">
                                            <h4>Full Name</h4>
                                            <input type="text" class="form-control" name="name" id="as-name" placeholder="Sender name" value="Kawthar Maktoum" required/>
										  </div>
										</div>
