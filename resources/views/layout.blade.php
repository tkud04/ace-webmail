...
<html>
    <head>
        <title>@yield('title') | YSG Global - Transportation and Logistics Worldwide</title>
        ...
        <!-- Stylesheets --
       <link rel="stylesheet" href="{{asset('vendor/bootstrap/css/bootstrap.min.css')}}"><!-- bootstrap grid -->
                    ...
                    <div class="row">
                        ...
                        <ul class="col-md-3 col-sm-6 footer-widget-container">
                            <li class="widget widget-text">
                                ...
                                <a href="javascript:void(0)">{{$pe['email']}}</a>
                                <br />
