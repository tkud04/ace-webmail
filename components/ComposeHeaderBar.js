...
const ComposeHeaderBar = (props) => {
	...
	{id: 4, name: 'send', title: 'Send', bgcolor: '#694fad', action: helpers.sendNewMessage, style: {marginRight:10}},
	{id: 2, name: 'text-box-remove', title: 'Discard', bgcolor: '#694fad', action: helpers.discardMessage}
